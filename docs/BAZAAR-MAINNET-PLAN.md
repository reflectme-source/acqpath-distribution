...
6. **SEPARATE PAYMENT APPROVAL:** if indexing still requires settlement, present exactly one indexing purchase, reviewed tier/cost, buyer identity separation, network, recipient and checkpoint/recovery plan. Await explicit approval and owner wallet signing. No standing spending permission is implied by deploy approval.

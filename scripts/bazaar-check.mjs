...
export async function validatePublicContract(root=ROOT){
 ...
 if(d.schema!=='acqpath.bazaar-public-contract.v1'||d.architecture!=='A_ADDITIVE_HTTP_ADAPTER'||d.appliedToCore!==true||d.productionDeployed!==false||d.productionEndpointActive!==false||d.indexing!=='UNVERIFIED'||d.settlementPerformed!==false)throw Error('UNPROVEN_DISCOVERY_CLAIM');
 ...
 return {status:d.status,schemas:'PASS',examples:'SYNTHETIC_SCHEMA_VALID',productionDeployed:false,indexing:'UNVERIFIED',noPaymentPerformed:true};
}

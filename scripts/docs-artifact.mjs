...
export function artifactPath(path){
 ...
 const sourceDownload=['examples/evidence-gate.mjs','examples/read-only.mjs','examples/read-only.py','examples/workflows.ts','examples/public-preflight.mjs','examples/public-preflight.py','examples/public-workflows.ts','examples/acqpath.mjs','examples/acqpath_httpx.py','examples/official-node.mjs','examples/official-python.py'].includes(path);

...
| [Coinbase x402 Bazaar](https://docs.cdp.coinbase.com/x402/seller/get-discovered) | A | LIVE_DISCOVERY_PURCHASE_BLOCKED | Public adapter deployed; unpaid 402/schema and CDP valid=true pass. Checked sources return zero-charge UNKNOWN; no prepared indexing purchase, payment or indexed readback. See docs/BAZAAR-ENGINEERING-STATUS.md. |
